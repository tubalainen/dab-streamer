 ...
 *
 * Note: welle-cli can only serve /slide/{sid} for the currently tuned service.
 * Logos for other stations will 404. The cache persists for the browser session,
 * so logos accumulate as the user switches between stations.
 */
